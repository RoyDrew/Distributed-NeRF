...
class Config:
  ...
  checkpoint_dir1: Optional[str] = None  # Where to log checkpoints.
  checkpoint_dir2: Optional[str] = None  # Where to log checkpoints.
  render_dir: Optional[str] = None  # Output rendering directory.
  data_dir: Optional[str] = None  # Input data directory.
  data_dir1: Optional[str] = None  # Input data directory.
  data_dir2: Optional[str] = None  # Input data directory.
